...
CREATE POLICY "secure_admins_view_all_orders" 
ON public.orders 
FOR SELECT 
USING (
  EXISTS (
...
CREATE POLICY "secure_order_creation" 
ON public.orders 
FOR INSERT 
WITH CHECK (
...
CREATE POLICY "secure_admins_update_orders" 
ON public.orders 
FOR UPDATE 
USING (
  EXISTS (
...
CREATE POLICY "secure_admins_delete_orders" 
ON public.orders 
FOR DELETE 
USING (
  EXISTS (
...
CREATE POLICY "secure_order_items_view" 
...
CREATE POLICY "secure_admins_manage_order_items" 
ON public.order_items 
FOR ALL 
USING (
  EXISTS (
